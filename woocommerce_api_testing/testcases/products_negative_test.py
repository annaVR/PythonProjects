...
def test_ng_tc3_empty_string_for_input():
    '''

    :return:
    '''
    test_case_number = 3
    test_case_description = 'negative, "products" endpoint, empty string for input'
    ...
    exp_error_msg = 'No product data specified to create product'
    exp_error_code = 'woocommerce_api_missing_product_data'
    print(api_response_verification.verify_test_case_response(rs, test_case_number, test_case_description, exp_error_msg, exp_error_code))

# test_ng_tc1_product_empty_payload()
# test_ng_tc2_product_missing_title_key_in_payload()
test_ng_tc3_empty_string_for_input()